...
namespace Aaru.Devices
{
    ...
    public enum AtaCommands : byte
    {
        ...
        /// <summary>Erases all user data and isables the security lock</summary>
        ...
        /// <summary>Configurates the operating parameters for a stream</summary>
        ConfigureStream = 0x51,

        /// <summary>Reads data on an alloted time using DMA</summary>
        ReadStreamDmaExt = 0x2A,

        /// <summary>Reads data on an alloted time using PIO</summary>
        ReadStreamExt = 0x2B,

        /// <summary>Writes data on an alloted time using DMA</summary>
        WriteStreamDmaExt = 0x3A,

        /// <summary>Writes data on an alloted time using PIO</summary>
        WriteStreamExt = 0x3B,
    ...
    public enum SasiCommands : byte
    {
        ...
        /// <summary>Reserves the device for use by the iniator. SASI rev. 0a</summary>
        ReserveUnitOld = 0x12,
        ...
        /// <summary>Reserves the device for use by the iniator. ANSI X3T9.3 No. 185 (SASI)</summary>
        ReserveUnit = 0x16,
    ...
    public enum ScsiCommands : byte
    {
        ...
        /// <summary>Modifies the operating definition of the device with respect to commmands. SCSI-2 X3T9.2/375R rev. 10l</summary>
        ...
        /// <summary>Requets XOR data generated by an <see cref="XdWrite" /> or <see cref="Regenerate" /> command SBC-1 rev. 8c</summary>
        XdRead = 0x52,
        ...
        /// <summary>Requets the target to XOR the sent data with the data on the medium and return the results</summary>
        XdWriteRead = 0x53,
        ...
        /// <summary>Provides a mehotd to profile the performance of the drive MMC-2 rev. 11a</summary>
        GetPerformance = 0xAC,
        ...
        /// <summary>Gets informationn about all discs: CD-ROM, CD-R and CD-RW MMC-1 rev. 9</summary>
        ...
        /// <summary>Searches the medium for a contiguos set of written or blank blocks</summary>
        MediumScan = 0x38,
        ...
        /// <summary>Gets the maxium generation address for the specified block</summary>
        ReadGeneration = 0x29,
    ...
    public enum AtaProtocol : byte
    {
        ...
        /// <summary>No data is to be transfered</summary>
        NonData = 3,
        ...
        /// <summary>Requets device reset</summary>
        DeviceReset = 9,
    ...
    /// <summary>Indicates the STL which ATA register contains the length of data to be transfered</summary>
    ...
    public enum PlextorSubCommands : byte
    {
        ...
        /// <summary>Plextor accoustic management (disc related)</summary>
        SilentDisc = 0x06,

        /// <summary>Plextor accoustic management (tra related)</summary>
        SilentTray = 0x07,

        /// <summary>Plextor accoustic management</summary>
        Silent = 0x08,
    ...
    public enum MmcCommands : byte
    {
        ...
        /// <summary>Continuosly writes blocks until interrupted (ADTC, R1)</summary>
        ...
        /// <summary>64 bytes of tuning pattern is sent for SDR50 and SDR104 optinal sampling point detection (ADTC, R1)</summary>
        SendTuningBlock = 19,
