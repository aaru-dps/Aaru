...
namespace DiscImageChef.Database.Migrations
{
    ...
    [Migration("20180805182209_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFTest.Models.ATA", b =>
                {
                    b.HasOne("EFTest.Models.TestedMedia", "ReadCapabilities")
                        .WithMany()
            ...
            modelBuilder.Entity("EFTest.Models.Device", b =>
                {
                    b.HasOne("EFTest.Models.ATA", "ATA")
                        .WithMany()
                        .HasForeignKey("ATAId");

                    b.HasOne("EFTest.Models.ATA", "ATAPI")
                        .WithMany()
                        .HasForeignKey("ATAPIId");

                    b.HasOne("EFTest.Models.FireWire", "FireWire")
                        .WithMany()
                        .HasForeignKey("FireWireId");

                    b.HasOne("EFTest.Models.SecureDigital", "MultiMediaCard")
                        .WithMany()
                        .HasForeignKey("MultiMediaCardId");

                    b.HasOne("EFTest.Models.PCMCIA", "PCMCIA")
                        .WithMany()
                        .HasForeignKey("PCMCIAId");

                    b.HasOne("EFTest.Models.SCSI.SCSI", "SCSI")
                        .WithMany()
                        .HasForeignKey("SCSIId");

                    b.HasOne("EFTest.Models.SecureDigital", "SecureDigital")
                        .WithMany()
                        .HasForeignKey("SecureDigitalId");

                    b.HasOne("EFTest.Models.USB", "USB")
                        .WithMany()
                        .HasForeignKey("USBId");
                });
            ...
            modelBuilder.Entity("EFTest.Models.IntClass", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.SupportedMedia")
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.BlockDescriptor", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.Mode")
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.MMC.MMC", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.MMC.Features", "Features")
                        .WithMany()
                        .HasForeignKey("FeaturesId");

                    b.HasOne("EFTest.Models.SCSI.MMC.Mode2A", "ModeSense2A")
                        .WithMany()
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.Page", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.SCSI")
                        .WithMany("EVPDPages")
                        .HasForeignKey("SCSIId");
                });
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.SCSI", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.Inquiry", "Inquiry")
                        .WithMany()
                        .HasForeignKey("InquiryId");

                    b.HasOne("EFTest.Models.SCSI.Mode", "ModeSense")
                        .WithMany()
                        .HasForeignKey("ModeSenseId");

                    b.HasOne("EFTest.Models.SCSI.MMC.MMC", "MultiMediaDevice")
                        .WithMany()
                    ...
                    b.HasOne("EFTest.Models.SCSI.SSC.SSC", "SequentialDevice")
                        .WithMany()
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.SSC.SequentialMedia", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.SSC.SSC")
            ...
            modelBuilder.Entity("EFTest.Models.SCSI.SSC.SupportedDensity", b =>
                {
                    ...
                    b.HasOne("EFTest.Models.SCSI.SSC.SequentialMedia")
                        .WithMany("SupportedDensities")
            ...
            modelBuilder.Entity("EFTest.Models.TestedMedia", b =>
                {
                    b.HasOne("EFTest.Models.ATA")
                        .WithMany("RemovableMedias")
                        .HasForeignKey("ATAId");

                    b.HasOne("EFTest.Models.CHS", "CHS")
                        .WithMany()
                        .HasForeignKey("CHSId");

                    b.HasOne("EFTest.Models.CHS", "CurrentCHS")
                        .WithMany()
                        .HasForeignKey("CurrentCHSId");

                    b.HasOne("EFTest.Models.SCSI.MMC.MMC")
                        .WithMany("TestedMedia")
                        .HasForeignKey("MMCId");
            ...
            modelBuilder.Entity("EFTest.Models.UshortClass", b =>
                {
                    b.HasOne("EFTest.Models.SCSI.Inquiry")
                        .WithMany("VersionDescriptors")
                        .HasForeignKey("InquiryId");
                });
