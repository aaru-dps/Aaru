        ...
        static void ModeSense6(string devPath, Device dev)
        {
            ...
            switch(item)
            {
                ...
                case 2:
                    ...
                    if(buffer != null) DicConsole.WriteLine("{0}", Modes.PrettifyModeHeader6(buffer, dev.ScsiType));
                    DicConsole.WriteLine("Press any key to continue...");
                    System.Console.ReadKey();
                    System.Console.Clear();
                    DicConsole.WriteLine("Device: {0}", devPath);
        ...
        static void ModeSense10(string devPath, Device dev)
        {
            ...
            switch(item)
            {
                ...
                case 2:
                    ...
                    if(buffer != null) DicConsole.WriteLine("{0}", Modes.PrettifyModeHeader10(buffer, dev.ScsiType));
                    DicConsole.WriteLine("Press any key to continue...");
                    System.Console.ReadKey();
                    System.Console.Clear();
                    DicConsole.WriteLine("Device: {0}", devPath);
