...
#region IOpticalMediaImage Members
                                       ...
                                       out SectorStatus[] sectorStatus)
    {
        ...
        for(uint i = 0; i < length; i++)
        {
            ...
            ErrorNumber errno = ReadSectorLong(addr, negative, out byte[] sector, out SectorStatus status);
    ...
    static SectorStatus MapState(byte state) => state switch
                                                {
                                                    0 => SectorStatus.NotDumped, // ERROR_SKIP
                                                    1 => SectorStatus.Errored,   // ERROR_C2
                                                    _ => SectorStatus
                                                       .Dumped // SUCCESS_C2_OFF (2), SUCCESS_SCSI_OFF (3), SUCCESS (4)
                                                };
