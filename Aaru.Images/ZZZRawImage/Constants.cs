...
namespace DiscImageChef.DiscImages
{
    public partial class ZZZRawImage
    {
        ...
        readonly (MediaTagType tag, string name)[] writeOnlySidecars =
        {
            ...
            (MediaTagType.BD_DDS, ".dds.bin"), (MediaTagType.BD_DI, ".di.bin"),
            (MediaTagType.BD_SpareArea, ".sai.bin"), (MediaTagType.CD_LeadOut, ".leadout.bin"),
            (MediaTagType.MMC_CID, ".cid.bin"), (MediaTagType.MMC_CSD, ".csd.bin"),
            (MediaTagType.MMC_OCR, ".ocr.bin")
        };
    }
}