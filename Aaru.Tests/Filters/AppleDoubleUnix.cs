...
public class AppleDoubleUnix
{
    ...
    {
        _location = Path.Combine(Consts.TEST_FILES_ROOT, "Filters", "AppleDouble", "unix", "DOS_720.dmg");
        _sidecar  = Path.Combine(Consts.TEST_FILES_ROOT, "Filters", "AppleDouble", "unix", "%DOS_720.dmg");
    }
