...
namespace Aaru.Tests.Issues._507
{
    ...
    public class system2 : FsExtractIssueTest
    {
        public override string DataFolder =>
            Path.Combine(Consts.TEST_FILES_ROOT, "Issues", "Pending", "issue507", "PS4UPDATE2");
        public override string                     TestFile         => "system_fs_image.img";
