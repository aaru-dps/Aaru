...
namespace Aaru.Tests.Images.ShrinkWrap
{
    ...
    public class Raw
    {
        ...
        {
            "CDROM.lz", "DC6_RW_HFS_1440.lz", "DC6_RW_HFS_800.lz", "DC6_RW_HFS_DMF.lz", "DOS1440.lz", "DOS720.lz",
        ...
        readonly string _dataFolder =
            Path.Combine(Consts.TEST_FILES_ROOT, "Media image formats", "ShrinkWrap 3", "raw");
