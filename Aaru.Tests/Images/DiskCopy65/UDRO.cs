...
namespace Aaru.Tests.Images.DiskCopy65
{
    ...
    public class UDRO : BlockMediaImageTest
    {
        ...
        public override BlockImageTestExpected[] Tests => new[]
        {
            ...
            {
                TestFile   = "DC6_UDRO_DOS_1440.img.lz",
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_DOS_720.img.lz",
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_DOS_DMF.img.lz",
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_HFS_1440.img.lz",
                MediaType  = MediaType.DOS_35_HD,
                Sectors    = 2880,
                SectorSize = 512,
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_HFS_800.img.lz",
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_HFS_DMF.img.lz",
                MediaType  = MediaType.DMF,
                Sectors    = 3360,
                SectorSize = 512,
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_PD_1440.img.lz",
                MediaType  = MediaType.DOS_35_HD,
                Sectors    = 2880,
                SectorSize = 512,
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_PD_800.img.lz",
                MediaType  = MediaType.AppleSonyDS,
                Sectors    = 1600,
                SectorSize = 512,
            ...
            new BlockImageTestExpected
            {
                TestFile   = "DC6_UDRO_PD_DMF.img.lz",
                MediaType  = MediaType.DMF,
                Sectors    = 3360,
                SectorSize = 512,
