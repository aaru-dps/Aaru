    ...
    public class CDRWin : ImagePlugin
    {
        ...
        public override bool OpenImage(Filter imageFilter)
        {
            ...
            try
            {
                ...
                if(track_count == 0) throw new FeatureUnsupportedImageException("No tracks found");
                ...
                while(cueStream.Peek() >= 0)
                {
                    ...
                    else
                    {
                        ...
                        else if(MatchDiskID.Success)
                        {
                            ...
                            if(!intrack) discimage.disk_id = MatchDiskID.Groups[1].Value;
                            else
                                throw new
                                    FeatureUnsupportedImageException(string
                        ...
                        else if(MatchFile.Success)
                        {
                            ...
                            {
                                case CDRWinDiskTypeLittleEndian: break;
                ...
                for(int s = 1; s <= _sessions.Length; s++)
                {
                    ...
                    if(s > 1) _sessions[s - 1].StartSector = _sessions[s - 2].EndSector + 1;
                    else _sessions[s - 1].StartSector = 0;
                    ...
                    for(int i = 0; i < cuetracks.Length; i++)
                    {
                        if(cuetracks[i].session == s)
                        {
                            ...
                            if(i > last_session_track) last_session_track = i;
                        }
                    }
                ...
                for(int s = 1; s <= _sessions.Length; s++) discimage.sessions.Add(_sessions[s - 1]);
                ...
                if(discimage.disk_id == null) DicConsole.DebugWriteLine("CDRWin plugin", "\tDisc ID not set.");
                else DicConsole.DebugWriteLine("CDRWin plugin", "\tDisc ID: {0}", discimage.disk_id);
                ...
                for(int i = 0; i < discimage.tracks.Count; i++)
                {
                    ...
                    if(discimage.tracks[i].flag_scms) DicConsole.DebugWriteLine("CDRWin plugin", "\t\tTrack has SCMS");
        ...
        static ushort CDRWinTrackTypeToBytesPerSector(string trackType)
        {
            ...
            {
                case CDRWinTrackTypeMode1:
                case CDRWinTrackTypeMode2Form1: return 2048;
                case CDRWinTrackTypeMode2Form2: return 2324;
                case CDRWinTrackTypeMode2Formless:
                case CDRWinTrackTypeCDI: return 2336;
                case CDRWinTrackTypeAudio:
                case CDRWinTrackTypeMode1Raw:
                case CDRWinTrackTypeMode2Raw:
                case CDRWinTrackTypeCDIRaw: return 2352;
                case CDRWinTrackTypeCDG: return 2448;
                default: return 0;
            }
        }
        ...
        static ushort CDRWinTrackTypeToCookedBytesPerSector(string trackType)
        {
            switch(trackType)
            {
                case CDRWinTrackTypeMode1:
                case CDRWinTrackTypeMode2Form1:
                case CDRWinTrackTypeMode1Raw: return 2048;
                case CDRWinTrackTypeMode2Form2: return 2324;
                case CDRWinTrackTypeMode2Formless:
                case CDRWinTrackTypeCDI:
                case CDRWinTrackTypeMode2Raw:
                case CDRWinTrackTypeCDIRaw: return 2336;
                case CDRWinTrackTypeAudio: return 2352;
                case CDRWinTrackTypeCDG: return 2448;
                default: return 0;
            }
        }
        ...
        static TrackType CDRWinTrackTypeToTrackType(string trackType)
        {
            ...
            {
                case CDRWinTrackTypeMode1:
                case CDRWinTrackTypeMode1Raw: return TrackType.CDMode1;
                case CDRWinTrackTypeMode2Form1: return TrackType.CDMode2Form1;
                case CDRWinTrackTypeMode2Form2: return TrackType.CDMode2Form2;
                case CDRWinTrackTypeCDIRaw:
                case CDRWinTrackTypeCDI:
                case CDRWinTrackTypeMode2Raw:
                case CDRWinTrackTypeMode2Formless: return TrackType.CDMode2Formless;
                case CDRWinTrackTypeAudio:
                case CDRWinTrackTypeCDG: return TrackType.Audio;
        ...
        static MediaType CDRWinIsoBusterDiscTypeToMediaType(string discType)
        {
            switch(discType)
            {
                case CDRWinDiskTypeCD: return MediaType.CD;
                case CDRWinDiskTypeCDRW:
                case CDRWinDiskTypeCDMRW:
                case CDRWinDiskTypeCDMRW2: return MediaType.CDRW;
                case CDRWinDiskTypeDVD: return MediaType.DVDROM;
                ...
                case CDRWinDiskTypeDVDPMRWDL2: return MediaType.DVDPRWDL;
                case CDRWinDiskTypeDVDPR:
                case CDRWinDiskTypeDVDPVR: return MediaType.DVDPR;
                case CDRWinDiskTypeDVDPRDL: return MediaType.DVDPRDL;
                case CDRWinDiskTypeDVDRAM: return MediaType.DVDRAM;
                case CDRWinDiskTypeDVDVR:
                case CDRWinDiskTypeDVDR: return MediaType.DVDR;
                case CDRWinDiskTypeDVDRDL: return MediaType.DVDRDL;
                case CDRWinDiskTypeDVDRW:
                case CDRWinDiskTypeDVDRWDL:
                case CDRWinDiskTypeDVDRW2: return MediaType.DVDRW;
                case CDRWinDiskTypeHDDVD: return MediaType.HDDVDROM;
                case CDRWinDiskTypeHDDVDRAM: return MediaType.HDDVDRAM;
                case CDRWinDiskTypeHDDVDR:
                case CDRWinDiskTypeHDDVDRDL: return MediaType.HDDVDR;
                case CDRWinDiskTypeHDDVDRW:
                case CDRWinDiskTypeHDDVDRWDL: return MediaType.HDDVDRW;
                case CDRWinDiskTypeBD: return MediaType.BDROM;
                case CDRWinDiskTypeBDR:
                case CDRWinDiskTypeBDRDL: return MediaType.BDR;
                case CDRWinDiskTypeBDRE:
                case CDRWinDiskTypeBDREDL: return MediaType.BDRE;
